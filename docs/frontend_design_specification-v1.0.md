...
- `#/chat`：支持 Supervisor 单智能体或跨知识库多智能体路由，也可手动指定智能体；展示协同轨迹、对话记忆状态、知识库、Tool Calls、Cited Nodes、网页来源和答案反馈。
- `#/agents`：智能体管理，支持配置智能体和无模型路由测试，并展示每个智能体的调用次数、基于用户反馈的准确率及平均延迟。
